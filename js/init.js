						...
						// If we found one ...
							...
							&&	!links.hasClass('scrollzer-locked'))
							{
								links.removeClass(settings.activeClassName)
										.siblings('ul.scroll-child').hide();
								elements[lastId].link
										.addClass(settings.activeClassName)
										.siblings('ul.scroll-child').show();
								elements[lastId].link
										.closest('ul.scroll-child').show()
										.prev('a').addClass(settings.activeClassName);
							}
					});
...
// Ready stuff
	jQuery(function() {
		...
		// Initialize nav
			...
			var $ulScrollChild = jQuery('ul.scroll-child');
				...
				$nav_a
					...
					.click(function(e) {
						...
						// Set this link to active
							t.addClass('active')
								.siblings('ul.scroll-child').show();
							t.closest('ul.scroll-child').show()
